        ...
        <div class="carousel-inner">
          ...
          <div class="carousel-item active">
            <div class="row justify-content-center">
              <div class="col-12 col-md-1 col-lg-12 usecase-slide" style="background-image: url('./assets/images/connectivity/Globalstar/Use Cases/Use\ Cases_Globalstar_Policing.png');">
          ...
          <div class="carousel-item ">
            <div class="row justify-content-center">
              <div class="col-12 col-md-1 col-lg-12 usecase-slide" style="background-image: url('./assets/images/connectivity/Globalstar/Use Cases/Use\ Cases_Globalstar_Maritime\ Logistics.png');">
                <div class="usecase-content">
                  <div class="usecase-text">
          ...
          <div class="carousel-item ">
            <div class="row justify-content-center">
              <div class="col-12 col-md-1 col-lg-12 usecase-slide" style="background-image: url('./assets/images/connectivity/Globalstar/Use Cases/Use\ Cases_Globalstar_Oil\ &\ Gas\ Operations.png');">
                <div class="usecase-content">
                  <div class="usecase-text">
          ...
          <div class="carousel-item ">
            <div class="row justify-content-center">
              <div class="col-12 col-md-1 col-lg-12 usecase-slide" style="background-image: url('./assets/images/connectivity/Globalstar/Use Cases/Use\ Cases_Globalstar_Construction.png');">
                <div class="usecase-content">
                  <div class="usecase-text">
          ...
          <div class="carousel-item ">
            <div class="row justify-content-center">
              <div class="col-12 col-md-1 col-lg-12 usecase-slide" style="background-image: url('./assets/images/connectivity/Globalstar/Use Cases/Use\ Cases_Orbcomm_Monitoring.png');">
                <div class="usecase-content">
                  <div class="usecase-text">
  ...
  <div class="container">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-4 col-sm-6 mb-4">
          <div class="benefits-card">
            <img src="assets/images/connectivity/Globalstar/Benefits of Customer/Benefits Of Customer_GlobalStar_Continuous tracking.png" alt="Tracking in Cellular Dark Zones" class="benefits-image rounded-4">
        ...
        <div class="col-md-4 col-sm-6 mb-4">
          <div class="benefits-card">
            <img src="assets/images/connectivity/Globalstar/Benefits of Customer/Benefits Of Customer_GlobalStar_Enhanced asset security.png" alt="Asset Security" class="benefits-image rounded-4">
            <div class="benefits-text">
        ...
        <div class="col-md-4 col-sm-6 mb-4">
          <div class="benefits-card">
            <img src="assets/images/connectivity/Globalstar/Benefits of Customer/Benefits Of Customer_Globalstar_Solar.png" alt="Flexible Deployment" class="benefits-image rounded-4">
            <div class="benefits-text">
      ...
      <div class="row justify-content-center second-row-benefit mt-4">
        ...
        <div class="col-md-4 col-sm-6 mb-4">
          <div class="benefits-card">
            <img src="assets/images/connectivity/Globalstar/Benefits of Customer/Benefits Of Customer_GlobalStar_Maintenance-free operation.png" alt="10 Year Operation" class="benefits-image rounded-4">
            <div class="benefits-text">
        ...
        <div class="col-md-4 col-sm-6 mb-4">
          <div class="benefits-card">
            <img src="assets/images/connectivity/Globalstar/Benefits of Customer/Benefits Of Customer_GlobalStar_high-risk environments.png" alt="High-Risk Certified" class="benefits-image rounded-4">
            <div class="benefits-text">
