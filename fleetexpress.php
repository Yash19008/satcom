...
?>
<title>Station Satcom | Fleet Xpress</title>
<meta name="keywords" content="FleetXpress maritime, hybrid satellite internet, marine connectivity solutions, KA Band VSAT, uninterrupted vessel internet">
<style>
    .hero-section {
        position: relative;
    ...
    .hero-section::after {
        ...
        background: linear-gradient(to bottom, rgba(0, 0, 0, 0.6) 60%, #000000 100%),
            /* smooth fade */
            url(assets/images/fleetxpress-bg.svg) center center / cover no-repeat;
    ...
    .usecase-slide {
        ...
        border-radius: 20px;
        overflow: hidden;
        background-image: url("assets/images/fleetxpress/fleet-use-case.svg");
        /* The image used */
...
<section class="breadcrumb">
    ...
    <a href="#"><span>Fleet Xpress</span></a>
</section>
<!-- banner section -->
<!-- Globalstar Section -->
<section class="globalstar-section">
    <div class="globalstar-overlay">
        <div class="globalstar-content">
            <h2 class="globalstar-title">FLEET XPRESS</h2>
...
<section class="uc-slider-wrapperr mb-5 mt-5">
                            ...
                            <div class="col-12 col-md-1 col-lg-12 usecase-slide">
                                <div class="usecase-content">
                                    <div class="usecase-text">
                                        ...
                                        <p>Secure ship-shore communication and crew intranet
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-12 col-md-1 col-lg-12 usecase-slide">
                                <div class="usecase-content">
                                    <div class="usecase-text">
                                        ...
                                        <p>High-speed internet for fishing vessels and luxury yachts
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="row row-cols-2 row-cols-sm-2 row-cols-md-3 justify-content-center g-4 g-md-5">
        <div class="col text-center">
            <div class="kb-card kb-global-coverage p-4 rounded">
                <div class="icon mb-3">
                    <img src="assets/images/fleetxpress/key/fleet-key-1.svg" alt="Continuous connectivity through a dual satellite constellation of KA and L Band">
                </div>
                <p>Continuous connectivity<br> through a dual satellite<br> constellation of KA and L Band</p>
            </div>
        </div>
        ...
        <div class="col text-center">
            <div class="kb-card kb-voice-data p-4 rounded">
                <div class="icon mb-3">
                    <img src="assets/images/fleetxpress/key/fleet-key-2.svg" alt="Optimized data routing for maximum efficiency">
                </div>
                <p>Optimized data<br> routing for maximum<br> efficiency</p>
            </div>
        </div>
        ...
        <div class="col text-center">
            <div class="kb-card kb-compact p-4 rounded">
                <div class="icon mb-3">
                    <img src="assets/images/fleetxpress/key/fleet-key-3.svg" alt="Secure and encrypted communication channels">
                </div>
                <p>Secure and encrypted<br> communication<br> channels</p>
            </div>
        </div>
        ...
        <div class="col text-center">
            <div class="kb-card kb-sos p-4 rounded">
                <div class="icon mb-3">
                    <img src="assets/images/fleetxpress/key/fleet-key-4.svg" alt="Scalable bandwidth solutions for different vessel sizes">
                </div>
                <p>Scalable bandwidth<br> solutions for different<br> vessel sizes</p>
            </div>
        </div>
        ...
        <div class="col text-center">
            <div class="kb-card kb-bandwidth p-4 rounded">
                <div class="icon mb-3">
                    <img src="assets/images/fleetxpress/key/fleet-key-5.svg" alt="Intelligent traffic management for cost-effective data usage">
                </div>
                <p>Intelligent traffic<br> management for<br> cost-effective data usage</p>
            </div>
        </div>
    ...
    <div class="row row-cols-2 row-cols-sm-2 row-cols-md-4 justify-content-center g-4 g-md-5">
        ...
        <div class="col text-center">
            <div class="kb-card kb-models p-4 rounded">
                <div class="icon mb-3">
                    <img src="assets/images/fleetxpress/tech/fleet-tech-1.svg" alt="Speeds Icon">
                </div>
                <p><strong>Multi-network support:</strong><br>GEO,and LBand</p>
            </div>
        </div>
        ...
        <div class="col text-center">
            <div class="kb-card kb-power p-4 rounded">
                <div class="icon mb-3">
                    <img src="assets/images/fleetxpress/tech/fleet-tech-2.svg" alt="Voice Icon">
                </div>
                <p><strong>Speed:</strong><br>Up to 8 Mbps (download), 4 Mbps (upload)</p>
            </div>
        </div>
        ...
        <div class="col text-center">
            <div class="kb-card kb-certifications p-4 rounded">
                <div class="icon mb-3">
                    <img src="assets/images/fleetxpress/tech/fleet-tech-3.svg" alt="Coverage Icon">
                </div>
                <p><strong>Global Coverage with 99.9% Availability</strong></p>
            </div>
        </div>
        ...
        <div class="col text-center">
            <div class="kb-card kb-communication p-4 rounded">
                <div class="icon mb-3">
                    <img src="assets/images/fleetxpress/tech/fleet-tech-4.svg" alt="Hardware Icon">
                </div>
                <p><strong>Hardware:</strong><br> Seamless integration with <br>automated network switching</p>
            </div>
        </div>
    </div>
        ...
        <section class="specialist-section container">
            <div class="fleet-cta-container text-center">
                <h2 class="fleet-cta-text">
                    Experience uninterrupted maritime connectivity with FleetXpress. Contact us
                    today.
