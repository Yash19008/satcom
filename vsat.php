        ...
        <div class="carousel-inner">
          ...
          <div class="carousel-item active">
            <div class="row justify-content-center">
              <div class="col-12 col-md-1 col-lg-12 usecase-slide" style="background-image: url('./assets/images/connectivity/VSAT/Use Cases/Use\ Cases_VSAT_Commercial\ Shipping.png');">
          ...
          <div class="carousel-item ">
            <div class="row justify-content-center">
              <div class="col-12 col-md-1 col-lg-12 usecase-slide" style="background-image: url('./assets/images/connectivity/VSAT/Use Cases/Use\ Cases_VSAT_Offshore\ Energy\ Platforms.png');">
                <div class="usecase-content">
                  <div class="usecase-text">
          ...
          <div class="carousel-item ">
            <div class="row justify-content-center">
              <div class="col-12 col-md-1 col-lg-12 usecase-slide" style="background-image: url('./assets/images/connectivity/VSAT/Use Cases/Use\ Cases_VSAT_Fishing\ Vessels.png');">
                <div class="usecase-content">
                  <div class="usecase-text">
          ...
          <div class="carousel-item ">
            <div class="row justify-content-center">
              <div class="col-12 col-md-1 col-lg-12 usecase-slide" style="background-image: url('./assets/images/connectivity/VSAT/Use Cases/Use\ Cases_VSAT_Government\ &\ Defense.png');">
                <div class="usecase-content">
                  <div class="usecase-text">
  ...
  <div class="container">
    ...
    <div class="container py-5">
      <div class="row">
        ...
        <div class="col-md-4 col-sm-6 mb-4">
          <div class="benefits-card">
            <img src="assets/images/connectivity/VSAT/Benefits of Customer/Benefits Of Customer_VSAT_Global Communication.png" alt="Global Communication" class="benefits-image">
            <div class="benefits-text">Ensures uninterrupted global communication for fleets</div>
          </div>
        </div>
        <div class="col-md-4 col-sm-6 mb-4">
          <div class="benefits-card">
            <img src="assets/images/connectivity/VSAT/Benefits of Customer/Benefits Of Customer_VSAT_Remote Operations.png" alt="Remote Operations" class="benefits-image">
            <div class="benefits-text">Supports remote operations, video conferencing, and data transfers</div>
          </div>
        </div>
        <div class="col-md-4 col-sm-6 mb-4">
          <div class="benefits-card">
            <img src="assets/images/connectivity/VSAT/Benefits of Customer/Benefits Of Customer_VSAT_Enhanced Crew welfare.png" alt="Crew Welfare" class="benefits-image">
      ...
      <div class="row justify-content-center second-row-benefit mt-5 ">
        ...
        <div class="col-md-4 col-sm-6 mb-4">
          <div class="benefits-card">
            <img src="assets/images/connectivity/VSAT/Benefits of Customer/Benefits Of Customer_VSAT_Reduced Costs.png" alt="Cost Reduction" class="benefits-image">
            <div class="benefits-text">Reduces operational costs with efficient data usage</div>
          </div>
        </div>
        <div class="col-md-4 col-sm-6 mb-4">
          <div class="benefits-card">
            <img src="assets/images/connectivity/VSAT/Benefits of Customer/Benefits Of Customer_VSAT_Compliance.png" alt="Compliance Standards" class="benefits-image">
