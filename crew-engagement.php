...
<div class="slider mb-1 pt-4 container">
    <div class="wrapper">
        <i id="left" class="fa-solid fa-arrow-left"></i>
        <div class="carousel">
            <img src="assets/images/Starlink_Logo.svg" alt="img" draggable="false">
            <img src="assets/images/oneweb-vector-logo.svg" alt="img" draggable="false">
            <img src="assets/images/orbcomm-seeklogo.svg" alt="img" draggable="false">
            <img src="assets/images/Globalstar_logo.svg" alt="img" draggable="false">
            <img src="assets/images/Starlink_Logo.svg" alt="img" draggable="false">
            <img src="assets/images/oneweb-vector-logo.svg" alt="img" draggable="false">
            <img src="assets/images/orbcomm-seeklogo.svg" alt="img" draggable="false">
            <img src="assets/images/Globalstar_logo.svg" alt="img" draggable="false">
        ...
        <div class="col">
            ...
            <div class="ips-card text-center" style="background-image: url('assets/images/crew-engagement/Crew\ Engagement_Station\ Connect\ &\ Engage.png');">
                ...
                <div class="ips-overlay">
                    ...
                    <div class="ips-desc"><p>Secure ship-shore communication and crew intranet.</p></div>
                </div>
            </div>
            </a>
        </div>
        ...
        <div class="col">
            ...
            <div class="ips-card text-center" style="background-image: url('assets/images/crew-engagement/Crew\ Engagement_Station\ Multiplex.png');">
                ...
                <div class="ips-overlay">
                    ...
                    <div class="ips-desc"><p>IPTV solution delivering live TV channels and entertainment.</p></div>
                </div>
            </div>
            </a>
        </div>
        ...
        <div class="col">
            ...
            <div class="ips-card text-center" style="background-image: url('assets/images/crew-engagement/Crew\ Engagement_Station\ Care.png');">
                ...
                <div class="ips-overlay">
                    ...
                    <div class="ips-desc"><p>24/7 telehealth services and mental health support.</p></div>
                </div>
            </div>
            </a>
        </div>
        ...
        <div class="col">
            ...
            <div class="ips-card text-center" style="background-image: url('assets/images/crew-engagement/Crew\ Engagement_Starlink\ for\ Crew.png');">
                ...
                <div class="ips-overlay">
                    ...
                    <div class="ips-desc"><p>High-speed, personal internet access enhancing morale.</p></div>
                </div>
            </div>
            </a>
        </div>
        <div class="col">
            ...
            <div class="ips-card text-center" style="background-image: url('assets/images/crew-engagement/Crew\ Engagement_Station\ Kiosk.jpg.png');">
                ...
                <div class="ips-overlay">
                    ...
                    <div class="ips-desc"><p>Digital noticeboard providing essential information</p></div>
                </div>
            </div>
            </a>
        </div>
...
<script>
  ...
  const imagesPerGroup = 1; // ONE image per dot
  const totalGroups = 4;
