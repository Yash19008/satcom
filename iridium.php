                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item active">
                        <div class="row justify-content-center">
                            <div class="col-12 col-md-1 col-lg-12 usecase-slide" style="background-image: url('./assets/images/connectivity/Iridium/Use Cases/Use\ Cases_Iridium_Commercial\ Shipping.png');">
                    ...
                    <div class="carousel-item ">
                        <div class="row justify-content-center">
                            <div class="col-12 col-md-1 col-lg-12 usecase-slide" style="background-image: url('./assets/images/connectivity/Iridium/Use Cases/Use\ Cases_Iridium_Offshore\ Energy\ Platforms.png');">
                                <div class="usecase-content">
                                    <div class="usecase-text">
                    ...
                    <div class="carousel-item ">
                        <div class="row justify-content-center">
                            <div class="col-12 col-md-1 col-lg-12 usecase-slide" style="background-image: url('./assets/images/connectivity/Iridium/Use Cases/Use\ Cases_Iridium_Expedition\ Yachts.png');">
                                <div class="usecase-content">
                                    <div class="usecase-text">
                    ...
                    <div class="carousel-item ">
                        <div class="row justify-content-center">
                            <div class="col-12 col-md-1 col-lg-12 usecase-slide" style="background-image: url('./assets/images/connectivity/Iridium/Use Cases/Use\ Cases_Iridium_Fishing\ Vessels.png');">
                                <div class="usecase-content">
                                    <div class="usecase-text">
...
<div class="platforms-container container">
    ...
    <div class="row">
        <div class="col-lg-3 col-6">
            ...
            <div class="platform-card connectivity" style="background-image: url('assets/images/connectivity/Iridium/Benefits of Customer/Benefits\ Of\ Customer_Iridium_Reliable\ Connectivity.png');">
        ...
        <div class="col-lg-3 col-6">
            ...
            <div class="platform-card cybersecurity" style="background-image: url('assets/images/connectivity/Iridium/Benefits of Customer/Benefits\ Of\ Customer_Iridium_Flexible\ Bandwidth.png');">
                <div class="overlay"></div>
                <div class="platforms-arrow-btn"></div>
                <div class="card-content">
        ...
        <div class="col-lg-3 col-6">
            ...
            <div class="platform-card crew-engagement" style="background-image: url('assets/images/connectivity/Iridium/Benefits of Customer/Benefits\ for\ Customer_Iridium_Enhanced\ Security.png');">
                <div class="overlay"></div>
                <div class="platforms-arrow-btn"></div>
                <div class="card-content">
        ...
        <div class="col-lg-3 col-6">
            ...
            <div class="platform-card operational-tech" style="background-image: url('assets/images/connectivity/Iridium/Benefits of Customer/Benefits\ Of\ Customer_Iridium_Operational\ Efficiency.png');">
                <div class="overlay"></div>
                <div class="platforms-arrow-btn"></div>
                <div class="card-content">
