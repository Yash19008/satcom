    ...
    <div class="globalstar-overlay">
        <div class="globalstar-content">
            ...
            <p class="globalstar-description">
                Station KIOSK is digital noticeboard providing essential information to the crew from various
                aspects (safety, corporate news, policy changes, promotion, birthday, crew change, feedback
                through QR code, etc)
                            ...
                            <div class="col-12 col-md-1 col-lg-12 usecase-slide usecase-slide-staioncrew-use1 position-relative">
                                ...
                                <div class="usecase-content">
                                    <div class="usecase-text">
                                        <h3>Cargo Ships</h3>
                                        <p>Live entertainment for long-haul voyages.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-12 col-md-1 col-lg-12 usecase-slide usecase-slide-staioncrew-use2 position-relative">
                                ...
                                <div class="usecase-content">
                                    <div class="usecase-text">
                                        ...
                                        <p>Low-bandwidth streaming in remote waters.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-12 col-md-1 col-lg-12 usecase-slide usecase-slide-staioncrew-use3 position-relative">
                                ...
                                <div class="usecase-content">
                                    <div class="usecase-text">
                                        <h3>Cruise Ships</h3>
                                        <p>Enhanced guest entertainment options.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-12 col-md-1 col-lg-12 usecase-slide usecase-slide-staioncrew-use4 position-relative">
                                ...
                                <div class="usecase-content">
                                    <div class="usecase-text">
                                        ...
                                        <p>TV access for isolated workers.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="row row-cols-2 row-cols-sm-2 row-cols-md-3 justify-content-center g-4 g-md-5">
        <div class="col text-center">
            <div class="kb-card kb-global-coverage p-4 rounded">
                ...
                <p>Essential information can be multicast <br>based on a vessel, broadcast to the fleet,<br>
        ...
        <div class="col text-center">
            <div class="kb-card kb-compact p-4 rounded">
                ...
                <p>Once in a day or whenever a news or information <br>to be shared.
                    Information remains<br> static till the time it is changed
                </p>
            </div>
        </div>
        ...
        <div class="col text-center">
            <div class="kb-card kb-sos p-4 rounded">
                ...
                <p>Crew always updated about current affairs<br> and news from across the
                    worls.
                </p>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 col-sm-6 mb-4">
                    <div class="benefits-card">
                        <img src="assets/images/Station-Kiosk/Benefits-for-Customers/1.webp" alt="Uninterrupted communication for crew and passengers" class="benefits-image rounded-4">
                ...
                <div class="col-md-4 col-sm-6 mb-4">
                    <div class="benefits-card">
                        <img src="assets/images/Station-Kiosk/Benefits-for-Customers/2.webp" alt="Cost-effective alternative to satellite-based services" class="benefits-image rounded-4">
                        <div class="benefits-text">
                ...
                <div class="col-md-4 col-sm-6 mb-4">
                    <div class="benefits-card">
                        <img src="assets/images/Station-Kiosk/Benefits-for-Customers/3.webp" alt="Supports essential applications such as email, messaging, and web Browse" class="benefits-image rounded-4">
                        <div class="benefits-text">
            ...
            <div class="row justify-content-center second-row-benefit mt-4">
                <div class="col-md-4 col-sm-6 mb-4">
                    <div class="benefits-card">
                        <img src="assets/images/Station-Kiosk/Benefits-for-Customers/4.webp" alt="Enhances crew welfare with personal mobile network access" class="benefits-image rounded-4">
                        <div class="benefits-text">
                            Content tailored to be multicast as per requirement.
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 mb-4">
    ...
    <div class="row row-cols-2 row-cols-sm-2 row-cols-md-4 justify-content-center g-4 g-md-5">
        ...
        <div class="col text-center">
            <div class="kb-card kb-models p-4 rounded">
                ...
                <p><strong>Digital screen via satellite and internet.</strong></p>
            </div>
        </div>
